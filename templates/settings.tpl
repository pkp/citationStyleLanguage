...
<form class="pkp_form" id="citationStyleLanguageSettingsForm" method="post" action="{url router=PKPApplication::ROUTE_COMPONENT op="manage" category="generic" plugin=$pluginName verb="settings" save=true}">
	{csrf}
